...
public class ChessModel {
	...
	public void reset() {
		...
		for(int i = 0; i < 2; i++) {
			...
			pieceBox.add(new ChessPiece(0 + i * 7, 0, Player.WHITE, Rank.ROOK, ChessConstants.wRook));
			...
			pieceBox.add(new ChessPiece(2 + i * 3, 0, Player.WHITE, Rank.BISHOP, ChessConstants.wBishop));
		...
		pieceBox.add(new ChessPiece(4, 0, Player.WHITE, Rank.KING, ChessConstants.wKing));
